...
function getSocialIconHtml(soc) {
  ...
  if (iconName === "logo-leetcode") {
    ...
    return `<svg class="socials-icons custom-svg" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><title>Kaggle</title><path d="M18.825 2.385c-.071 0-.108.037-.108.11v6.755c0 .073.037.11.108.11h.708c.072 0 .109-.037.109-.11V2.495c0-.073-.037-.11-.109-.11zm-15.823 0c-.072 0-.108.037-.108.11v19.01c0 .073.036.11.108.11h.708c.072 0 .109-.037.109-.11V12.186l4.226-4.02 6.046 8.35c.042.058.086.087.132.087h.931c.072 0 .108-.037.068-.11l-6.23-8.6 6.007-5.719c.05-.047.042-.11-.027-.11h-.946c-.058 0-.11.026-.149.07L7.337 7.794v-5.3c0-.073-.037-.11-.109-.11z"/></svg>`;
